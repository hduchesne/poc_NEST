...
<c:set var="linkID" value="${currentNode.properties.linkID.string}"/>
...
<c:choose>
    ...
    <c:when test="${buttonType eq 'collapse'}">
        ...
        <a href="#collapse-${currentNode.identifier}"
           id="${linkID}"
           class="${buttonClass}" ${aria} data-toggle="collapse"
           aria-expanded="false" aria-controls="collapse-${currentNode.identifier}">
                ${title}
        </a>
